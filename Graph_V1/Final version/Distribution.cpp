...
void MainWindow::setupgraph(QCustomPlot *customPlot){
        ...
        A.everyAssScore();
            ...
            // prepare y axis:
            customPlot->yAxis->setRange(0, sizeof(everyAss)/sizeof(double));
            ...
            QCPItemText *textLabel = new QCPItemText(customPlot);
            textLabel->position->setCoords(19.5, sizeof(everyAss)/sizeof(double)-0.5); // place position at center/top of axis rect
            ...
            textLabel_1->position->setCoords(21, sizeof(everyAss)/sizeof(double)-0.5);
            ...
            textLabel_2->position->setCoords(19.6, sizeof(everyAss)/sizeof(double)-0.7); // place position at center/top of axis rect
            ...
            textLabel_3->position->setCoords(21, sizeof(everyAss)/sizeof(double)-0.7);
