...
class Assignment
{
    ...
    public:
        ...
        //gets one submission (assume student only submits one thing) for a given student, based on student id
        //function is run for each student
        ...
        {
                return s << "Assignment " << a.m_assignment_id << ", Course " << a.m_course_id << std::endl;
        }
